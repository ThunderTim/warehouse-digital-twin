    ...
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        ...
        <div style={{
          ...
          color: "#fff", whiteSpace: "nowrap", marginLeft: 8,
        }}>
...
export function SlotContainer({
  ...
  // Stable ref to document.body for Html portal — avoids re-renders
  ...
  // ── Hover popup (rack view) ────────────────────────────────────────────────
  const hoverPopup = (
    <div>
      <strong style={{ fontSize: 13 }}>{slotId}</strong>
      {locationLine && (
        <div style={{ fontSize: 11, opacity: 0.55, marginTop: 2, letterSpacing: "0.05em" }}>
          {locationLine}
        </div>
      )}
  ...
  return (
    <group>
      ...
      {showLabel && slotId && (
        <Html position={[0, 0, 0]} center style={{ pointerEvents: "none", userSelect: "none" }}>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1px" }}>
            {section && (
              <div style={{
                color: "#ffffff", fontSize: "12px", fontWeight: 300,
                fontFamily: "monospace", letterSpacing: "0.08em", lineHeight: "1",
                backgroundColor: "#000000b7", borderRadius: "8px", padding: "6px 8px",
            ...
            <div style={{
              color: "#ffffff", fontSize: "11px", fontWeight: 300,
      ...
      {/* ── Slot view: detail panel portalled to body via drei Html ───────────
          portal={portalRef} puts the DOM into <body>, escaping the canvas.
          position: fixed on the inner div escapes drei's 3D transform wrapper,
          anchoring it to the viewport instead of the 3D object position.      */}
      {popupMode === "always" && (
        <Html portal={portalRef} position={[0, 0, 0]}>
          <div style={{
            position: "fixed",
            top: "50%",
            right: 24,
            transform: "translateY(-50%)",
            zIndex: 100,   // above canvas, but below Modal which should be 1000+
            width: 252,
            maxHeight: "80vh",
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ height: 6, borderRadius: 4, background: "rgba(255,255,255,0.1)", overflow: "hidden" }}>
                  <div style={{
                    height: "100%", width: `${fillPctDisplay}%`,
                    borderRadius: 4, background: isEmpty ? "transparent" : fillColor,
              ...
              {items.length > 0 ? (
                <div style={{ display: "grid", gap: 6 }}>
                  <div style={{
                    fontSize: 11, opacity: 0.4, letterSpacing: "0.07em",
                ...
                <div style={{
                  fontSize: 12, opacity: 0.4, textAlign: "center",
                  borderTop: "1px solid rgba(255,255,255,0.07)", paddingTop: 10,
                  fontStyle: "italic",
                }}>
      ...
      {/* Rack view: standard hover popup via Interactable */}
      <Interactable
